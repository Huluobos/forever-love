<template>
  <div class="roll">
    ...
    <button class="start_btn" @click="openBox()">开始</button>
    <button class="start_btn" @click="resetBox()">重置</button>
  </div>
</template>
...
.btns {
  ...
  width: 277px;
  height: 41px;
  background: url("../assets/img/bg_btn.png") 0 0 no-repeat;
  position: absolute;
  bottom: 90px;
  left: 50%;
...
.con {
  ...
  margin: 0 auto;
  overflow-x: hidden;
  background: url("../assets/img/list_bg.png") 0 234px no-repeat;
